# Generated by Django 4.0.5 on 2023-02-24 21:01
...
def copy_addon_spec(apps, schema_editor):
    ...
    for plan_template in PlanTemplate.objects.filter(addon_spec__isnull=False):
...
class Migration(migrations.Migration):
    dependencies = [
        ("metering_billing", "0208_remove_plantemplate_parent_plan_and_more"),
    ]
